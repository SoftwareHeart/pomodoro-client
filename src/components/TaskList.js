...
function TaskList({ tasks, onSelectTask, onDeleteTask, onCompleteTask, onAddTask, activeTaskId, isTimerActive, activeStartAt, loading }) {
    ...
    // Süre formatlayıcı - akıllı birim gösterimi
    const formatDuration = (totalSeconds) => {
        ...
        if (h > 0) {
            // 1 saat ve üzeri için saat:dakika formatı
            return `${h}s ${m}dk`;
        } else if (m > 0) {
            // 1 dakika ve üzeri için sadece dakika
            return `${m}dk`;
        } else {
            // 1 dakikadan az için saniye
            return `${seconds}sn`;
        }
    };
                                    ...
                                    >
                                        <div className="task-info">
                                            ...
                                            {expandedTaskIds.has(task.id) && (
                                                <div className="task-details enhanced">
                                                    ...
                                                    <div className="detail-section">
                                                        ...
                                                        <div className="detail-chips">
                                                            <span className="chip primary" title="Görev oluşturulma tarihi">
                                                                ...
                                                                Oluşturuldu: {formatRelativeDate(task.startTime)}
                                                            </span>
                                                            {task.isCompleted && task.endTime && (
                                                                <span className="chip success" title="Görev tamamlanma tarihi">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                                                        <polyline points="22 4 12 14.01 9 11.01"></polyline>
                                                                    </svg>
                                                                    Tamamlandı: {formatRelativeDate(task.endTime)}
                                                                </span>
                                                            )}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="detail-section">
                                                        ...
                                                        <div className="detail-chips">
                                                            <span className="chip info" title="Bugünkü toplam çalışma süresi">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                            ...
                                                            {getMinutesSpent(task) !== null && (
                                                                <span className="chip secondary" title="Bu görevde harcanan süre">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                        <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path>
                                                                    </svg>
                                                                    Bu seans: {getMinutesSpent(task)}dk
                                                                </span>
                                                            )}
                                                            <span className="chip accent" title="Tüm zamanlar toplam çalışma süresi">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                    ...
                                                    <div className="detail-section">
                                                        ...
                                                        <div className="detail-chips">
                                                            <span className={`chip ${task.isCompleted ? 'success' : 'warning'}`} title="Görev durumu">
                                                                {task.isCompleted ? (
                                                                    <>
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                                            ...
                                                            {task.id === activeTaskId && (
                                                                <span className="chip primary" title="Aktif görev">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
