...
function StatisticsPanel() {
    ...
    // Giriş yapmayan kullanıcılar için özel prompt
    if (!isAuthenticated()) {
        return (
            <div className="statistics-panel modern">
                ...
                <LoginPrompt 
                    message="Performansınızı Takip Edin"
                    actionText="Detaylı istatistikler, haftalık raporlar ve ilerleme grafikleri için giriş yapın. Verileriniz güvenle saklanır ve tüm cihazlarınızda senkronize edilir."
                    showBenefits={false}
                />
